                                                ...
                                                <div class="text-center md-6">
                                                    <a class="nav-link nav-icon-hover">
                                                        ...
                                                        if (file_exists($imageFileName)) {
                                                            echo '<img src="' . $imageFileName . '" alt width="350" height="350" class="rounded-circle">';
                                                        } else {
                                                            echo '<img src="../assets/images/profile/default.jpg" alt width="350" height="350" class="rounded-circle">';
                                                        }
                                                        ?>
                                                    </a>
                                                </div>
