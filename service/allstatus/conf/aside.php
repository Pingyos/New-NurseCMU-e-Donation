        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar>
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="../../finance/index.php" aria-expanded="false">
                        <span>
                            <i class="ti ti-layout-dashboard"></i>
                        </span>
                        <span class="hide-menu">การเงิน</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="../../store/index.php" aria-expanded="false">
                        <span>
                            <i class="ti ti-user-plus"></i>
                        </span>
                        <span class="hide-menu">ส่งของ</span>
                    </a>
                </li>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="invoice_person.php" aria-expanded="false">
                        ...
                        <span class="hide-menu">สำหรับ บุคคลทั่วไป</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="invoice_corporation.php" aria-expanded="false">
                        ...
                        <span class="hide-menu">สำหรับ บริษัท/นิติบุคคล</span>
                    </a>
                </li>
                <li class="nav-small-cap">
                    <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="invoice.php" aria-expanded="false">
                        ...
                        <span class="hide-menu">รายงานใบเสร็จ</span>
                    </a>
                </li>
                <li class="sidebar-item">
